...
Simple frontend to cater login and register user functionality
...
Typical Endpoints Note: Confirm exact paths in the code; these are common defaults and may differ.
